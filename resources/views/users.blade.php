...
<div class="users-section">
  ...
  <div class="users-table-card">
          ...
          <tr data-name="{{ $user->name }}" data-role="{{ $user->role }}" data-status="actif">
            ...
            <td>
              <div class="table-actions" style="justify-content:flex-end">
                ...
                <button class="btn-delete" type="button" onclick="openDeleteModal({{ $user->id }},'{{ $user->name }}')">
    ...
    <div class="users-table-footer">
      <span class="table-footer-info" id="usersFooterInfo">Affichage de {{ $users->count() }} utilisateurs</span>
      <div class="page-btns">
